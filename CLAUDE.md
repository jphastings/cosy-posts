...
Pact-based contract tests live in `api/contract_test.go`. The pact file (`contracts/CosyPostsApp-CosyPostsAPI.json`) is generated by the Swift consumer tests (PactSwift in `app/`).
